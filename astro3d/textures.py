...
class TextureMask(object):
    ...
    def resize(self, shape):
        """
        Return the texture mask resized to the given ``shape``.

        Parameters
        ----------
        shape : tuple
            Desired shape of the texture mask.
    ...
    @classmethod
    def read(cls, filename, shape=None):
        """
        Read a texture mask from a FITS file generated by :meth:`save`.
        ...
        shape : tuple
            ...
            ``shape``.  This is used to resize the texture mask to the
            size of the image in the GUI, etc.

        Returns
        -------
        result : `TextureMask`
            A `TextureMask` instance.
        """
